...
public class FmMerger {
    ...
    public TreeSet<LocalDate> readAndMerge(List<PraBean> praBeans, LocalDate forDate) throws FileNotFoundException {
        ...
        String foPreviousFileName = praFileUtils.getLatestFileNameFor(NseCons.FM_FILES_PATH, ApCo.PRA_FM_FILE_PREFIX, ApCo.REPORTS_FILE_EXT,2, forDate);
