...
public class ApCo {
    ...
    public static final LocalDate DOWNLOAD_NSE_FROM_DATE = LocalDate.of(2021,10,18);
    ...
    public static final LocalDate RE_UPLOAD_CALC_FROM_DATE = LocalDate.of(2021,10,18);
