...
public class ApCo {
    ...
    public static final LocalDate DOWNLOAD_NSE_FROM_DATE = LocalDate.of(2021,1,1);
    public static final LocalDate UPLOAD_NSE_FROM_DATE  = LocalDate.of(2021,1,1);

    public static final LocalDate CALC_FROM_DATE        = LocalDate.of(2021,1,1);
    public static final LocalDate CALC_FROM_DATE_NEW    = LocalDate.of(2021,1,1);
    public static final LocalDate UPLOAD_CALC_FROM_DATE = LocalDate.of(2021,1,1);

    public static final LocalDate REPORTS_FROM_DATE     = LocalDate.of(2021,1,1);
    public static final LocalDate EMAIL_FROM_DATE       = LocalDate.of(2021,1,1);
