...
public class ApCo {
    ...
    public static final LocalDate DOWNLOAD_NSE_FROM_DATE = LocalDate.of(2021,8,16);
    public static final LocalDate TRANSFORM_NSE_FROM_DATE  = LocalDate.of(2021,8,16);
    public static final LocalDate UPLOAD_NSE_FROM_DATE  = LocalDate.of(2021,8,16);
    //
    public static final LocalDate DO_CALC_FROM_DATE = LocalDate.of(2021,8,16);
    public static final LocalDate UPLOAD_CALC_FROM_DATE = LocalDate.of(2021,8,16);
    //
    public static final LocalDate REPORTS_FROM_DATE     = LocalDate.of(2021,8,16);
    public static final LocalDate EMAIL_FROM_DATE       = LocalDate.of(2021,8,16);

    public static final boolean RE_UPLOAD_CALC = false;
    public static final LocalDate RE_UPLOAD_CALC_FROM_DATE = LocalDate.of(2021,8,16);
